...
import 'package:ecommerce/model/support/ErrorListener.dart';
...
class RestManager {
  ...
  Future<String> makePostRequestParam(String serverAddress, String servicePath, [Map<String, String> value, TypeHeader type]) async {
    return _makeRequest(serverAddress, servicePath, "post", type, value: value);
  }
  ...
  Future<String> makeGetRequestParam(String serverAddress, String servicePath, [Map<String, String> value, TypeHeader type]) async {
